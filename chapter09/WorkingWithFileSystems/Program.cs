...
WriteLine($"Random File Name: {GetRandomFileName()}"); // Just returns a filename.
WriteLine($"Temporary File Name: {GetTempFileName()}"); // Created a zero-bytes file and returns its name, ready for use.
#endregion
